...
int debug(memory_array* tab_m, instruction_array* tab_i, reg registers[]);
WINDOW** initWindow(memory_array* tab_m, instruction_array* tab_i, reg registers[], char(*PSR)[], const char *headers[]);
...
void refresh_all(WINDOW** windows, memory_array* tab_m, instruction_array* tab_i, int instruction_offset, int memory_offset);